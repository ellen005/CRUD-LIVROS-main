<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('livros.update', $livro->id) }}" enctype="multipart/form-data" class="grid gap-6 md:grid-cols-2">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" id="autor" name="autor"
                           ...
                           placeholder="Digite o nome do autor" value="{{old('autor', $livro->autor)}}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="titulo" name="titulo"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Digite um Título" value="{{old('titulo', $livro->titulo)}}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="subtitulo" name="subtitulo"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Digite um Subtitulo" value="{{old('subtitulo', $livro->subtitulo)}}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="edicao" name="edicao"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Digite a Edição" value="{{old('edicao', $livro->edicao)}}">
                </div>
                <div>
                    <label for="editora"
                    ...
                    <input type="text" id="editora" name="editora"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Digite a Editora" value="{{old('editora', $livro->editora)}}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="anoPublicado" name="anoPublicado"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Digite o ano Publicado" value="{{old('anoPublicado', $livro->anoPublicado)}}">
                </div>
